                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="{{ url ('loginUsers') }}" method="post" class="user" >
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <input type="email" name="post_email" class="form-control form-control-user"
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="login">Đăng nhập Admin?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="registerusers">Đăng ký tài khoản?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
