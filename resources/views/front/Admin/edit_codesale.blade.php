                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Sửa Thông tin mã giảm giá</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('updateCode', $post->id )}}" method="POST" class="user">
                                @method("POST")
                                @csrf
